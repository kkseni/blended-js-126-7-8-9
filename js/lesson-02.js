...
// const isCapitalized = login[0] === login[0].toUpperCase();
//     if (array.includes(login) && isCapitalized) {
//         alert(`Welcome, ${login}!`);
//     } else {
...
//     return newArray;
// }
// console.log(someArr);               // console.table(someArr)
// console.log(getSum(someArr));       //console.table(getSum(someArr))
...
//==============
// function findAllLongestWords(string) {
...
// console.log(findAllLongestWords("London is the capital of Great Britain"));
// Виведе: ["capital", "Britain"]
...
// Додатково, якщо все зробили або хочеться ще, можна зробити цю задачу:
