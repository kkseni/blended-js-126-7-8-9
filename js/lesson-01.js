...
// if (min >= 45 && min < 60) {
//     alert(`${min} лежить у четвертій чверті`)
// } else if (min >= 30 && min < 45) {
//     alert(`${min} лежить у третій чверті`)
// } else if (min >= 15 && min < 30) {
//     alert(`${min} лежить у другій чверті`)
// } else if (min >= 0 && min < 15) {
//     alert(`${min} лежить у першій чверті`)
// }
